...
#>
function rdp {
    param([ValidateSet("jbuedel1-pc","buildagent1","dev.fpweb.net","ampdev.net","www1","www2", "mercury.fpweb.net","orchestrator","tickets.fpweb.net","vmm","lansweeper","ams-jbuedel.amscorp.net","ams-build-01.amscorp.net", "ams-tfs-01", "test-eclipse-02", "demo.amscontrols.com")][string]$server)
